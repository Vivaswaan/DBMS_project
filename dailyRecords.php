...
<body style="background-color: #babab8;">
<?php
...
<div class="container">
    ...
    <form class='border-light' action='dailyRecords.php' method='post'>
        <div class='float-right mb-3 ml-3'>
            ...
            <input class='float-right my-1 btn btn-info btn-block' name='search' type='submit' value='Search' style='background-color:#36210e; color: blanchedalmond;'>
        </div>
    ...
    <form class='border-light' action='dailyRecords.php' method='post'>
        ...
        <input class='btn btn-info my-4' name='update_production' type='submit' value='Update Records' style="position: relative; left: 40%; background-color:#36210e; color: blanchedalmond;">
    </form>
