...
<body>
	...
	<?php
		...
		echo "<p class='h4 my-3 text-center' style='color: #4d3d01; font-family: sans serif; font-size: 2.0rem;'>Add New Products</p><hr>";
		...
		<div class=" col-md-12 ">
            ...
            <form class="border-light" action="manageProducts.php" method="post">
                ...
                <div class="form-row mb-4">
                    <div class="col">
                        <p>Products Name:*</p>
                        <input type="text" name="productsName" class="form-control " placeholder="e.g. Notepad" required>
                    </div>
                    <div class="col">
                        <p>Price:*</p>
