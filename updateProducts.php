...
?>
<p class="h4 my-3 text-center" style='color: #4d3d01; font-family: sans serif; font-size: 2.0rem;'>Update Products Info</p><hr>
                        ...
                        while ($product = mysqli_fetch_assoc($query_products)) {
                            ...
                            echo "
								<tr>
									...
									<td><input type='text' value='$name' name='productsName[]' class='form-control ' placeholder='e.g. Notepad' required></td>
